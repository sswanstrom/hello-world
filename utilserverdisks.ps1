$servers = get-content utilservers.txt

ForEach ($server in $servers) {

$server | out-file utilserverdisks.txt -append
...
@{n='Percent Free';e={'{0:N2}'-f ($_.FreeSpace/$_.Size*100)+"%"}} -AutoSize | out-file utilserverdisks.txt -append
